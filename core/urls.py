...
, dash_stock_grafico, lista_compras, dashboard_estoque, financeiro_mensal,
                    gerar_backup, criar_usuario_padrao, quitar_pendente, editar_produto,
                    abrir_caixa, registrar_saida_caixa, fechar_caixa,
                    MovimentosCaixaView)  # ou importe as views necessárias
...
urlpatterns = [
                  ...
                  path('abrir-caixa/', abrir_caixa, name='abrir_caixa'),
                  path('registrar_saida_caixa/', registrar_saida_caixa, name='registrar_saida_caixa'),
                  # urls.py
                  path('fechar-caixa/', fechar_caixa, name='fechar_caixa'),
                  path('caixas/', MovimentosCaixaView.as_view(), name='lista_caixas'),
