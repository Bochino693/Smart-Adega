...
# ---------- STATIC FILES ----------
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # WhiteNoise serve daqui
STATICFILES_DIRS = [BASE_DIR / 'static']  # suas pastas locais de static
...
# WhiteNoise Settings adicionais (opcional, mas recomendado)
WHITENOISE_AUTOREFRESH = DEBUG  # útil para dev
